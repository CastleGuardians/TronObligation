class GuiOptionsControls extends Gui {
  ...
  GuiOptionsControls(boolean render) {
    super(render);
    this.buttonSounds = new Button("Sounds", subtitleFont, 35, 20, color(223, 116, 12), width / 2 - 600, 150, 300, 50, color(12, 23, 31), color(0, 47, 47), color(0, 57, 57));
    this.buttonGraphics = new Button("Graphics", subtitleFont, 35, 20, color(223, 116, 12), width / 2 + 300, 150, 300, 50, color(12, 23, 31), color(0, 47, 47), color(0, 57, 57));
  }
